            ...
            $.post("/blog/index.php/User/register", o, function(e) {
                ...
                if(e.status!=200){
                    ...
                    for(i=0;i<e.cap.length;i++){
                        !$('[name='+e.cap[i].name+']').siblings("[class='help-block err']").length ? $('[name='+e.cap[i].name+']').parent().append('<span class="help-block err">'+e.cap[i].value+'</span>'):$('[name='+e.cap[i].name+']').next()[0].innerHTML = e.cap[i].value;
