...
<script>
    ...
    $(document).ready(function (){
        ...
        str= regisStr.replace('{verifyImg}',verifyImg).replace("{partyStr}",partyStr).replace("{loRore}",'<a class="btn-block btn btn-default pull-right pl20 pr20 SFLogin" href="<?php echo U('User/login');?>"> 已有账号登录 </a>')
