                        ...
                        <form class="news__form--post" id="submit"  method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <p class="mt10 js-news--news-type" data-sharetypeitem="null">
                                    <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><button type="button" class=" mr10 btn btn-xs btn-default" data-item="{&quot;id&quot;:&quot;<?php echo ($val["id"]); ?>&quot;,&quot;name&quot;:&quot;<?php echo ($val["name"]); ?>&quot;,&quot;url&quot;:&quot;Channel/<?php echo ($val["url"]); ?>&quot;,&quot;slug&quot;:&quot;<?php echo ($val["url"]); ?>&quot;}"><?php echo ($val["name"]); ?></button><?php endforeach; endif; else: echo "" ;endif; ?>
                                </p>
                            </div>
