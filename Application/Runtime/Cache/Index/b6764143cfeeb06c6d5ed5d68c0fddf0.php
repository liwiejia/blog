...
<div class="wrap publish">
    <div class="container">
        <form id="write" method="POST" class="form">
            <input class="hidden" data-init="null" name="userid" type="text"  value="<?php echo ($info["id"]); ?>">
            <div class="input-group form-group">
                <div class="input-group-btn">
                    <button type="button" style="height:46px;margin-right:-2px;" class="btn btn-default btn-lg dropdown-toggle blog__type-toggle" data-type="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><span>原创</span> <span class="caret"></span></button>
                    <ul class="dropdown-menu" data-type="set_type">
                        <li><a href="#" class="blog__type-1">原创</a></li>
                        <li><a href="#" class="blog__type-2">转载</a></li>
                        <li><a href="#" class="blog__type-3">翻译</a></li>
                    </ul>
                </div><!-- /btn-group -->
                <input name="type" class="hidden" value="1">
                <input id="myTitle" type="text" name="title" required="" data-error="" autocomplete="off" class="form-control tagClose input-lg" placeholder="标题：那是我夕阳下的奔跑" value="">
            </div>
            <div class="form-group hide">
                <input type="text" name="url" class="form-control" placeholder="请输入原文链接">
            </div>
            <div class="row" style="margin-left:0;margin-right:0">
                ...
                <div role="tabpanel" class="techTags panel panel-default techTags-panel" data-tech="" style="display: nono;">
                    <ul class="nav nav-tabs" role="tablist">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li role="presentation" class="active"><a href="#<?php echo ($val["name"]); ?>" aria-controls="type" role="tab" data-toggle="tab"><?php echo ($val["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                    <div class="tab-content">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div role="tabpanel active" class="tab-pane " id="<?php echo ($val["name"]); ?>">
                                <ul class="taglist--inline">
                                    <?php if(!empty($val["children"])): if(is_array($val["children"])): $i = 0; $__LIST__ = $val["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="mb5">
                                                <a class="tag" data-tag="{&quot;id&quot;:&quot;<?php echo ($v["id"]); ?>&quot;,&quot;name&quot;:&quot;<?php echo ($v["name"]); ?>&quot;,&quot;iconUrl&quot;:&quot;<?php echo ($v["iconurl"]); ?>&quot;}" href="javascript: void(0);">
                                                    <?php if($v["iconurl"] != ''): ?><img src=" <?php echo ($v["iconurl"]); ?>"><?php endif; ?>
                                                    <?php echo ($v["name"]); ?>
                                                </a>
