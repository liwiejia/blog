    ...
    <div class="ace-settings-box clearfix" id="ace-settings-box">
        ...
        <div class="pull-left width-50">
            ...
            <!-- /section:basics/sidebar.options -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal form" action="/blog/index.php/Admin/Menu/add.html" method="post">
            ...
            <textarea name="tips" data-provide="markdown" data-iconlibrary="fa" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
