                ...
                <div class="row">
                    <form class="form-horizontal" id="form" role="form" method="post" action="<?php echo U('update');?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="sitename" id="sitename" class="rcol-xs-10 col-sm-5"  value="<?php echo ($vars[0][value]); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="title" id="title" class="rcol-xs-10 col-sm-5"  value="<?php echo ($vars[3][value]); ?>">
                                <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="keywords" id="keywords" class="rcol-xs-10 col-sm-5"  value="<?php echo ($vars[5][value]); ?>">
                                <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                    <textarea name="description" id="description" placeholder="网站描述"
                                              class="col-xs-10 col-sm-5" rows="5"><?php echo ($vars[4][value]); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                    <textarea name="footer" id="footer" placeholder="网站描述"
                                              class="col-xs-10 col-sm-5" rows="5"><?php echo ($vars[2][value]); ?></textarea>
...
<script>
    ...
    {type: 'image', name: 'Logo', path: '<?php echo ($vars[1][value]); ?>'},
    ]);
</script>
</body>
</html>